...
namespace SimpleWebBrowser
{
    ...
    public class WebBrowser : MonoBehaviour, IInputClickHandler, IInputHandler
    {
        ...
        {
            RaycastHit hit;
            var test = GazeManager.Instance.HitInfo;
            if (
                !Physics.Raycast(GazeManager.Instance.Ray, out hit))
